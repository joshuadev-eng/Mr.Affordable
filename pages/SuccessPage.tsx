      ...
      <div className="container mx-auto px-4 max-w-lg text-center">
        <div className="mb-8 relative inline-block">
          <div className="w-32 h-32 bg-green-100 rounded-full flex items-center justify-center mx-auto animate-pulse">
            <i className="fa-solid fa-check text-6xl text-green-600"></i>
          </div>
        ...
        <p className="text-xl text-gray-600 mb-10 leading-relaxed">
          Thank you for shopping with <span className="text-blue-600 font-bold">Mr.Affordable</span>. 
        ...
        <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 mb-10 text-left">
          ...
          <ul className="space-y-3 text-gray-600">
            <li className="flex items-start">
              <i className="fa-solid fa-circle-1 text-blue-500 mr-3 mt-1 text-sm"></i>
              <span>Our team will confirm your order on WhatsApp shortly.</span>
            </li>
            <li className="flex items-start">
              <i className="fa-solid fa-circle-2 text-blue-500 mr-3 mt-1 text-sm"></i>
              <span>We will verify your delivery address and location.</span>
            </li>
            <li className="flex items-start">
              <i className="fa-solid fa-circle-3 text-blue-500 mr-3 mt-1 text-sm"></i>
        ...
        <Link 
          to="/" 
          className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-10 py-4 rounded-full shadow-lg transition-all hover:scale-105"
        >
          Return to Shop
        </Link>
      </div>
